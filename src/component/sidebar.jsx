...
export default function SideBar({ onItemClick }) {
  ...
  return (
    <div
      ...
      } h-[100vh] w-[250px] shadow-xl bg-gradient-to-b from-green-500 from-70% to-green-300 drop-shadow-sideshadow`}
    >
      <div className="flex flex-col items-center mt-7 text-center">
        <img
          src="src/assets/profile-pict.png"
          className="rounded-lg shadow-lg h-20 items-center w-20"
        ></img>
      ...
      <List className="text-white mt-5">
        <ListItem
          ...
          className={`hover:bg-black focus:bg-white focus:bg-opacity-50 ${
            DashboardActive ? "bg-white bg-opacity-50" : "bg-transparent"
          }`}
        >
          <ListItemPrefix>
        ...
        <ListItem
          ...
          className={`hover:bg-black focus:bg-white focus:bg-opacity-50 ${
            DashboardActive ? "bg-transparent" : "bg-white bg-opacity-50"
          }`}
        >
          <ListItemPrefix>
      ...
      <div className="mb-10 self-center">
        <Button
          className="flex flex-row w-36 h-[35px] font-bold align-middle items-center rounded-full"
          color="white"
        >
          <ArrowLeftOnRectangleIcon
            width={20}
            className="mr-2 fill-green-700"
          />
